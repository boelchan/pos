            ...
            <div class="col">
                <div class="card" style="min-height: 85vh">
                    <div class="card-header bg-white">
                        <div class="row">
                            <div class="col">
                                <h4 class="font-weight-bold">Report / Laporan Transaksi</h4>
                            </div>
                            <div class="col"><a class="btn btn-primary float-right btn-sm" href="{{ route('cetak.laporan', $transaksi->invoices_number) }}" target="_blank"><i class="fas fa-print"></i>
                                    Print</a>
